...
<form class="max-w-md mx-auto" @submit.prevent="submitForm">
  <div class="relative z-0 w-full mb-5 group">
      <input  v-model="title" type="text" name="title" id="title" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div  v-if="selectedId === 1" class="relative z-0 w-full mb-5 group">
    <input v-model="url1" type="text" name="url-1" id="url-1" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div  v-if="selectedId === 2" class="relative z-0 w-full mb-5 group"  v-for="n in 5" :key="n">
    <input v-model="urls[n-1]" :id="'url-' + n" :name="'url-' + n" type="text" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
...
watch(title, (newValue) => console.log('Title:', newValue));
watch(description, (newValue) => console.log('Description:', newValue));
watch(buttonTitle, (newValue) => console.log('ButtonTitle:', newValue));
watch(url1, (newValue) => console.log('URL1:', newValue));
watch(urls, (newValue) => console.log('URLs:', newValue));
